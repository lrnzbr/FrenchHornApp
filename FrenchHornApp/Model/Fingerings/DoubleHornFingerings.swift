...
private let t000 = Fingering(id: 7, trigger1: true, valve1: false, valve2: false, valve3: false)
private let t010 = Fingering(id: 8, trigger1: true, valve1: false, valve2: true, valve3: false)
private let t011 = Fingering(id: 9, trigger1: true, valve1: false, valve2: true, valve3: true)
private let t100 = Fingering(id: 10, trigger1: true, valve1: true, valve2: false, valve3: false)
private let t110 = Fingering(id: 11, trigger1: true, valve1: true, valve2: true, valve3: false)



let doubleHornFingerings: [Note : [Fingering]] = [
	C2:[open],
	CSharp2: [t011],
	DFlat2: [t011],
	D2: [t110],
